  ...
  render () {
    return (
      <div className='main-content'>
        ...
        <p>The special feature, <b><em>Muslims on the Belt and Road: New Silk Road Social Transformations in Inner Asia</em></b>, was created in collaboration with <a href="https://eurasianet.org/" target="_blank">Eurasianet</a>, an independent news organization that covers news from and about the South Caucasus and Central Asia. Eurasianet provides on-the-ground reporting and critical perspectives on the most important developments in the region. It strives to provide information useful to policymakers, scholars, and interested citizens both in and outside of Eurasia. Content is published in both English and Russian. Eurasianet is a tax-exempt [501(c)3] organization based at Columbia University’s Harriman Institute, one of the leading centers in North America of scholarship on Eurasia.</p>
      </div>
    )
  }
}
